...
const images = [
  {
    _id: '1',
    image:
      'https://genk.mediacdn.vn/2019/8/9/photo-1-15652951577231693720798.jpg',
    name: "Komi-san can't communicate",
  },
  {
    _id: '2',
    image:
      'https://cdn.zenquiz.net/external/2017/04/04/05/bebc94d0-18fa-11e7-a896-050901070303-compressed.jpg',
    name: "Masamune's Revenge",
  },
  {
    _id: '3',
    image:
      'https://cdn.oneesports.vn/cdn-data/sites/4/2022/03/Kaguya-sama-Chapter-220-Release-Date-Spoilers-Raws-Scans-Leaks-and-Read-Manga-Online.jpeg',
    name: 'Kaguya-san: Love is War',
  },
  {
    _id: '4',
    image:
      'https://genk.mediacdn.vn/thumb_w/600/DlBlzccccccccccccE5CT3hqq3xN9o/Image/2013/12/ava-15c70.jpg',
    name: 'Nisekoi',
  },
];
const Slider = props => {
  ...
  let currentIndex = 0;
  useEffect(() => {
    const scrollInterval = setInterval(autoUpdateScrollIndex, 8000);
    console.log('aloooo');
  }, []);
