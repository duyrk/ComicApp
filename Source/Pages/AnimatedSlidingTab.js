        ...
        <View>
          ...
          <ScrollView nestedScrollEnabled={true}>
            <Animated.View
              ...
              <View style={{marginTop: 20}}>
                ...
                <Text style={{lineHeight: 20}}>
                  Nisekoi kể về chuyện tình tay ba xoay quanh Ichijō Raku,
                  Kirisaki Chitoge và Onodera Kosaki. Raku là con trai của ông
                  trùm băng đảng yakuza tên Shuei-gumi và cậu đang thầm thích
                  bạn học cùng lớp Kosaki. Cho đến khi có một cuộc hẹn hò giả
                  tạo với cô gái Chitoge điều gì sẽ xảy ra tiếp theo...?
                </Text>
              </View>
              <View style={{marginTop: 20}}>
                <Text
            ...
            <Animated.View
              ...
              <View>
                {this.props.characterData.map(item => (
