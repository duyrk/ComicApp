        ...
        <View style={[styles.container]}>
            <View style={styles.socialContainer}>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 20 }}>
                    <Text style={[Typographies.h5, { color: AppColors.primary_black }]}>Don't have an account?</Text>
                    <Pressable><Text style={[Typographies.h5, { color: '#2079FF', marginStart: 5 }]}>Sign Up!</Text></Pressable>
                </View>
            </View>
            <View style={[styles.defautLogin]}>
                <LinearGradient colors={['#A2B2FC', '#FFF1BE']} style={{ flex:1, justifyContent:'space-between' }} >
                    ...
                    <View style={{ paddingHorizontal: 45, marginTop: 40 }}>
                        ...
                        <Pressable style={{ alignSelf: 'flex-end', marginTop: 10 }}><Text style={[Typographies.h6, { color: AppColors.primary_white }]}>Forgot password?</Text></Pressable>
                    </View>
                    </View>
